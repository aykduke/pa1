...
#ifndef SKIBOT_INTERFACES__SRV__DETAIL__TELEPORT__FUNCTIONS_H_
#define SKIBOT_INTERFACES__SRV__DETAIL__TELEPORT__FUNCTIONS_H_
...
#include "skibot_interfaces/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_skibot_interfaces
bool
 ...
 * calls
 * skibot_interfaces__srv__Teleport_Request__init().
...
/**
 * It calls
 * skibot_interfaces__srv__Teleport_Request__fini()
 ...
 * skibot_interfaces__srv__Teleport_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * skibot_interfaces__srv__Teleport_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * skibot_interfaces__srv__Teleport_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_skibot_interfaces
...
/**
 * It calls
 * skibot_interfaces__srv__Teleport_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_skibot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * skibot_interfaces__srv__Teleport_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_skibot_interfaces
...
/**
 * It calls
 * skibot_interfaces__srv__Teleport_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SKIBOT_INTERFACES__SRV__DETAIL__TELEPORT__FUNCTIONS_H_
