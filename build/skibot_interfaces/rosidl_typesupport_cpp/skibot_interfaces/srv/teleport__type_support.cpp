...
static const _Teleport_Request_type_support_symbol_names_t _Teleport_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, skibot_interfaces, srv, Teleport_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, skibot_interfaces, srv, Teleport_Request)),
  }
};
...
{
  return &::skibot_interfaces::srv::rosidl_typesupport_cpp::Teleport_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, skibot_interfaces, srv, Teleport_Request)() {
  return get_message_type_support_handle<skibot_interfaces::srv::Teleport_Request>();
}
...
static const _Teleport_Response_type_support_symbol_names_t _Teleport_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, skibot_interfaces, srv, Teleport_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, skibot_interfaces, srv, Teleport_Response)),
  }
};
...
{
  return &::skibot_interfaces::srv::rosidl_typesupport_cpp::Teleport_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, skibot_interfaces, srv, Teleport_Response)() {
  return get_message_type_support_handle<skibot_interfaces::srv::Teleport_Response>();
}
...
static const _Teleport_type_support_symbol_names_t _Teleport_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, skibot_interfaces, srv, Teleport)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, skibot_interfaces, srv, Teleport)),
  }
};
...
{
  return &::skibot_interfaces::srv::rosidl_typesupport_cpp::Teleport_service_type_support_handle;
}
