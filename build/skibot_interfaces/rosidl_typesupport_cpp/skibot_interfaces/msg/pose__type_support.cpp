...
static const _Pose_type_support_symbol_names_t _Pose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, skibot_interfaces, msg, Pose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, skibot_interfaces, msg, Pose)),
  }
};
...
get_message_type_support_handle<skibot_interfaces::msg::Pose>()
{
  return &::skibot_interfaces::msg::rosidl_typesupport_cpp::Pose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, skibot_interfaces, msg, Pose)() {
  return get_message_type_support_handle<skibot_interfaces::msg::Pose>();
}
